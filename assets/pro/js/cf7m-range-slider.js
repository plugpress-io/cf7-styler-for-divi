 ...
 * Supports both new (.cf7m-range-slider) and legacy (.dcs-range-slider) classes.
 */
(function () {
  'use strict';
  ...
  function initOne(container) {
    ...
    var display = container.querySelector('.cf7m-range-value') || container.querySelector('.dcs-range-value');
  ...
  function init() {
    ...
    // Legacy classes
    document.querySelectorAll('.dcs-range-slider').forEach(initOne);
  }
