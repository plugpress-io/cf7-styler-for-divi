		...
		<div className="dcs-help-list">
			{RESOURCES.map((r) => (
				<a
					...
					className="dcs-help-item"
				>
					<div className="dcs-help-item-text">
						<span className="dcs-help-item-title">{r.title}</span>
						<span className="dcs-help-item-desc">{r.desc}</span>
					</div>
					<svg className="dcs-help-arrow" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
