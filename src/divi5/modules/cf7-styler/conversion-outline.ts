/**
 * Conversion outline: Divi 4 → Divi 5 attribute mapping for CF7 Styler.
 * Build compiles this file to conversion-outline.json in the same folder;
 * CopyWebpackPlugin then copies JSON to plugin root modules-json/.
 *
 * Structure follows Elegant Themes d5-example-core-modules (e.g. blog conversion-outline).
 * @see https://github.com/elegantthemes/d5-example-core-modules/blob/main/blog/visual-builder/conversion-outline.ts
 * @see https://devalpha.elegantthemes.com/docs/explanations/module/conversion-outline/introduction
 */
...
export const conversionOutline: ModuleConversionOutline = {
  ...
  css: {
    ...
    after: 'css.*.after',
    formContainer: 'css.*.formContainer',
    formFields: 'css.*.formFields',
    formLabels: 'css.*.formLabels',
    formInputs: 'css.*.formInputs',
