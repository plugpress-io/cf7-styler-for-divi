			...
			<div className="dcs-v3-banner__inner">
				...
				<div className="dcs-v3-banner__content">
					<p className="dcs-v3-banner__title">
						{__('Welcome to CF7 Mate', 'cf7-styler-for-divi')} <span className="dcs-v3-banner__ver">v3.0.0</span>
					</p>
				...
				<button type="button" className="dcs-v3-banner__dismiss" onClick={handleDismiss} disabled={dismissing} aria-label={__('Dismiss', 'cf7-styler-for-divi')}>
