 ...
 * Free features listed first, then Pro.
 *
 * @package CF7_Mate
 */
...
export const FEATURES = [
	...
	{
		id: 'phone_number',
		name: __('Phone Number Field', 'cf7-styler-for-divi'),
		description: __(
			'Phone input with country prefix, searchable country selector and flags.',
			'cf7-styler-for-divi'
		),
		isPro: true,
		icon: 'phone',
