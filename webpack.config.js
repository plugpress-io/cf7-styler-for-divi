...
module.exports = {
	entry: {
		...
		responses: './src/admin/responses-index.js',
		analytics: './src/admin/analytics-index.js',
		'settings-pro': './src/admin/settings-pro.js',
		'responses-pro': './src/admin/responses-pro.js',
		'analytics-pro': './src/admin/analytics-pro.js',
